        ...
        <div className="r-w md:flex md:items-start md:gap-5 md:justify-between">
          <div className="mb-8 md:mb-0">
            ...
            <p className="text-white text-sm text-justify md:w-[400px]">
              ...
              services offered by International Schooling to students, parents,
          ...
          <div className="w-full md:w-max mt-10 md:mt-0">
            <Image
              ...
              width={250}
              height={150}
              className="h-auto mb-4  m-auto md:ml-0"
            />
            <Image
              ...
              width={250}
              height={150}
              className="h-auto  m-auto md:ml-0"
            />
          </div>
        </div>
      </div>
      <div className="w-full bg-slate-900 py-6">
        <div className="r-w  text-white md:flex md:items-center md:justify-between md:gap-5  ">
          <p className="text-xs md:text-sm text-center md:text-left  mb-4 md:mb-0">
            Copyright © 2024 - International Schooling - All Rights Reserved.
          </p>
          <div className="flex w-full md:w-max justify-center items-center gap-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
              width={30}
              height={30}
              className="fill-slate-200 hover:fill-white cursor-pointer h-auto"
            >
